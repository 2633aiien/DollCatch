//
//  NotiHistoryFirstViewController.swift
//  DollCatch
//
...
class NotiHistoryFirstViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.firstTableView.performBatchUpdates(nil)
        
    }
    func tableView(_ tableView: UITableView, didDeselectRowAt indexPath: IndexPath) {
        if let cell = self.firstTableView.cellForRow(at: indexPath) as? DetailTableViewCell {
            cell.hideDetailView()
        }
    }
    
    func getNotifyHistory() {
        let url = URL(string: "https://www.surveyx.tw/funchip/push_history_store.php")!
