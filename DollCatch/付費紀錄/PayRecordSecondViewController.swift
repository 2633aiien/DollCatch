//
//  PayRecordSecondViewController.swift
//  DollCatch
//
...
class PayRecordSecondViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getPayHistory() {
        let url = URL(string: "https://www.surveyx.tw/funchip/pay_record_machine.php")!
